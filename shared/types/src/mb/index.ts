...
export interface IArea
  extends ITypedEntity, IMayHaveRelations, IMayHaveTagsAndGenres {
  type:
    | 'Country'
    | 'Subdivision'
    | 'Municipality'
...
export interface IRelease
  extends IEntity, IMayHaveRelations, IMayHaveTagsAndGenres {
  title: string;
...
export interface IRecording
  extends IEntity, IMayHaveRelations, IMayHaveTagsAndGenres, IMayHaveRating {
  video: boolean;
  length: number;
  title: string;
  disambiguation: string;
 ...
 */
export type ReleaseStatusQuery =
  | 'official'
  | 'promotion'
  | 'bootleg'
  | 'pseudo-release'
